...
/// \class model.h
/// \brief stores a model as a set of triangulated meshes
/// \todo
...
public:
    ...
    /// @param[in] *_path the folder path
    /// @param[in] &_directory the directory
    /// @param[in] _gamma sets gamma use
    ...
    /// @brief list of meshes in the model
    vector<Mesh> meshes;
    /// @brief the object directory
    string directory;
    /// @brief gamma correction - unused
